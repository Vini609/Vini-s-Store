        ...
        <>
            <div className="px-[8%] py-20 lg:px-[16%]">
                <div className="flex flex-col justify-between gap-5 md:flex-row">
                    <div>
                        <h2 className="Lufga text-5xl font-medium">O que está em alta</h2>
                        <p className="GolosText mt-1 text-lg">
                            Descubra os produtos mais populares  Vini's Store
                        </p>
                    </div>
                    <div>
                        <button className="btn GolosText cursor-pointer rounded-md bg-black px-6 py-3 text-xl text-white transition-all duration-380">Ver tudo
                                ...
                                <div className='product-card cursor-pointer'>
                                    <div className='product-image overflow-hidden rounded-2xl'>
                                        ...
                                        <div className='absolute right-5 top-5 flex flex-col gap-2'>
                                            <i
                                                onClick={() => addToWhishList(item)} className='bi bi-balloon-heart product-icon flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-black/40 text-white'></i>
                                            <div className="absolute right-5 top-5 flex flex-col gap-2">
                                            ...
                                            <i onClick={() => addToCart(item)} className='bi bi-cart3 product-icon flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-black/40 text-white'></i>
                                        </div>
